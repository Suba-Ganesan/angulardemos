...
export class AdminDashboardComponent implements OnInit {
  ...
  sortData(sort:Sort){
    ...
    this.sortedProd=data.sort((a,b):any=>{
      const isAsc = sort.direction === 'asc';
      switch(sort.active){
        case 'name':return this.compare(a.name,b.name,isAsc);
        case 'desc':return this.compare(a.name,b.name,isAsc);
        case 'customername':return this.compare(a.category,b.category,isAsc);
        case 'mobilenum':return this.compare(a.category,b.category,isAsc);
  ...
  addProduct(){
    ...
    // this.productModelObj.mobilenum=this.formValue.value.mobilenum;
  ...
  onEdit(prod:any){
    ...
    // this.formValue.controls['mobilenum'].setValue(prod.mobilenum);
